...
class Tree {
    ...
    function get_treeview_menu($myid,$effected_id='example', $str="<span class='file'>\$name</span>", $str2="<span class='folder'>\$name</span>", $showlevel = 0,  $ul_class="" ,$li_class="" , $style='filetree ', $currentlevel = 1, $recursion=FALSE, $dropdown='hasChild') {
    	...
    	foreach ($child as $id => $a) {
    		...
    		$this->str .= $recursion ? "<ul class='$ul_class'><li  $floder_status>" : "<li $floder_status data-am-dropdown=''>";
  		    /*$this->str .= $recursion ? "<ul class='$ul_class'><li  $floder_status id= 'menu-item-$id'>" : "<li  $floder_status   id= 'menu-item-$id' data-am-dropdown=''>";*/
    		$recursion = FALSE;
    		//判断是否为终极栏目
